...
--
-- Table structure for table `deckcarta`
--
...
CREATE TABLE `deckcarta` (
  ...
  KEY `fk_carta_deck` (`id_deck`),
  CONSTRAINT `fk_carta_deck` FOREIGN KEY (`id_deck`) REFERENCES `deck` (`id`),
  CONSTRAINT `fk_deck_carta` FOREIGN KEY (`id_carta`) REFERENCES `carta` (`id`)
